...
public partial class ClusterViewModel : ObservableObject, IKubernetesResourceEventSubscriber
{
    ...
    )
    {
        return (resourceType.Group, resourceType.Version, resourceType.Plural) switch
        {
            ...
            (V1DaemonSet.KubeGroup, V1DaemonSet.KubeApiVersion, V1DaemonSet.KubePluralName) =>
                new DaemonSetViewModel((V1DaemonSet)resource, this),
            ...
            ) => new PersistentVolumeViewModel((V1PersistentVolume)resource, this),
            (
            ...
            ) => new ClusterRoleBindingViewModel((V1ClusterRoleBinding)resource, this),
            (V1RoleBinding.KubeGroup, V1RoleBinding.KubeApiVersion, V1RoleBinding.KubePluralName) =>
